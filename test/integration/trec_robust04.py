...
class TestTrecRobust04(DatasetIntegrationTest):
    def test_trec_robust04_docs(self):
        # self._build_test_docs('trec-robust04')
        self._test_docs('trec-robust04', count=528155, items={
            0: TrecDoc('FBIS3-61341', re.compile('^\n\nLanguage:  Armenian \nArticle Type:CSO \n\n \\[Interview with Air Force Aviation Chief Col Aleksandr \nA.{4030}\\-\\- "It is our duty to do \nso\\." And it is the duty of all of us to strengthen the National \nArmy\\. \n\n\n$', flags=48), re.compile('^<TEXT>\nLanguage: <F P=105> Armenian </F>\nArticle Type:CSO \n\n<F P=106> \\[Interview with Air Force Avia.{4077}is our duty to do \nso\\." And it is the duty of all of us to strengthen the National \nArmy\\. \n\n</TEXT>\n$', flags=48)),
            9: TrecDoc('FBIS3-61350', re.compile('^\n\nLanguage:  Ukrainian \nArticle Type:CSO \n\n \\[Interview with Candidate of Legal Sciences A\\. Buteyko b.{13725}lly acceptable solutions\\. \n  I think that the development of events will follow this very \npath\\. \n\n\n$', flags=48), re.compile('^<TEXT>\nLanguage: <F P=105> Ukrainian </F>\nArticle Type:CSO \n\n<F P=106> \\[Interview with Candidate of .{13763}eptable solutions\\. \n  I think that the development of events will follow this very \npath\\. \n\n</TEXT>\n$', flags=48)),
            528154: TrecDoc('LA012890-0192', re.compile('^\n\n\nJanuary 28, 1990, Sunday, Home Edition \n\n\n\n\nON THE RUN WITH TV\'S MARATHON MAN; \n\n\nPRODUCER DEAN H.{15209} to see a cassette\\. \n\n\nHargrove wanted to change the subject: "Nothing\'s available on that one\\." \n\n\n$', flags=48), re.compile('^<DATE>\n<P>\nJanuary 28, 1990, Sunday, Home Edition \n</P>\n</DATE>\n<HEADLINE>\n<P>\nON THE RUN WITH TV\'S .{15864}\\. \n</P>\n<P>\nHargrove wanted to change the subject: "Nothing\'s available on that one\\." \n</P>\n</TEXT>\n$', flags=48)),
        })
